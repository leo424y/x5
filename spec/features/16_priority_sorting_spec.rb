...
describe "Task priority sorting", type: :feature do   
  it "can be desc from 1 to 3" do
    ...
    expect(page).to have_content(/task 1 todo 1 Edit Destroy task 2 todo 2 Edit Destroy/i)
  end
  ...
  it "can be asc from 3 to 1" do
    ...
    expect(page).to have_content(/task 2 todo 2 Edit Destroy task 1 todo 1 Edit Destroy/)
  end
end